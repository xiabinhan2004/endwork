/*
 * Created by JFormDesigner on Sun May 30 19:54:24 CST 2021
 */
 ...
 * @author Flat-White
 */
public class AgreeApply extends JDialog {
    private int applyId;
    private int adminId;
    private String applyNote;

    public AgreeApply(Window owner, int applyId) {
        super(owner);
    ...
    private void ok(KeyEvent e) {
        if (e.getKeyChar() == KeyEvent.VK_ENTER){
            ...
            try {
                ...
                map.put("staId", staId);
                int i = adminMapper.adminAgreeApply(map);
                if (i > 0){
                    System.out.println("adminAgreeApply Successfully!");
                    JOptionPane.showMessageDialog(null, "同意申请成功！", "Info", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
                }
